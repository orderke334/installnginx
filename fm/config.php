...
try {
    ...
    foreach ($users as $user) {
        $auth_users += [$user['username'] => $user['password']];
        $directories_users += [$user['username'] => $user['dir']];
    }    
...
/*
$auth_users = array(
    'berkah' => '$2y$10$CrztQnUcnBULFSPlE7bQXOSWsO2PHd5bCXFmezM.669uxAotknYVG',
    'user' => '$2y$10$vkB0KzZJxMomO0wLNVVdQ.j80KxzeMOq63H2A8vsVQN1U42Jfrjqa',
    'wildan' => '$2y$10$vkB0KzZJxMomO0wLNVVdQ.j80KxzeMOq63H2A8vsVQN1U42Jfrjqa' 
);
...
$directories_users = array(
    'berkah' => '/data/www/',
    'user' => '/data/www/ab.dlingo.net/',
    'wildan' => '/data/www/aa.dlingo.net/'
    );
*/
